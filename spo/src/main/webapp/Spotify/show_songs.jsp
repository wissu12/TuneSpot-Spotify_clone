    ...
    <header>
        <div class="menu_side">
            <h1>TuneSpot</h1>
             ...
             <% if (((ArrayList<Song>) request.getAttribute("songs2")).isEmpty()) { %>
					
					<% } %><%else{ %>
						
						 <h3 style=" margin-left:20px;margin-top:14px;">Latest songs</h3>
					<% } %>
            <div class="menu_song" style="margin-top:14px;">
            ...
            <div class="popular_song" style="margin-top:90px;">
                ...
                <div class="pop_song">
                 <% if (((ArrayList<Song>) request.getAttribute("songs")).isEmpty()) { %>
					   <div style="margin-top:14px;color:red;">Aucune chanson trouvée</div>
					<% } %>
                    <% for (Song songObj : (ArrayList<Song>) request.getAttribute("songs")) { %>
                        <li class="songItem">
                            <div class="img_play">
                                <img id="songImage"  src="image_songs/<%= songObj.getImage() %>" alt="" srcset="">
...
const song<%=j%> = {
    ...
    coverPath: "image_songs/<%= ((ArrayList<Song>) request.getAttribute("songs2")).get(j).getImage() %>"
};
songs.push(song<%=j%>);
